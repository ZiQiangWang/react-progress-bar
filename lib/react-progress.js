    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (typeof trigger === 'boolean') {
        ...
        if (nextTrigger) {
          ...
          this.setState(_extends({}, this.state, { style: initStyle }), function () {
            setTimeout(function () {
              _this2.setState(_extends({}, _this2.state, { style: nextStyle }));
            }, 100);
          });
        } else {
          nextStyle = _extends({}, style, {
          ...
          this.setState(_extends({}, this.state, { style: nextStyle }));
        }
      } else if (typeof trigger === 'number') {
        var percent = parseInt(nextTrigger, 10);
